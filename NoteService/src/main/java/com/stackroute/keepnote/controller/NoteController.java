...
public class NoteController {
	 ...
	 */
	@ApiOperation(value="Delete a Note using userid and noteid")
	...
	@ApiOperation(value="Delete All Notes using userid")
	 ...
	 * 
	 */
	@ApiOperation(value="Get specific note by a userId")
